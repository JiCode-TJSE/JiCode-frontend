...
import { getAccountInfoRequest, updateAccountInfoRequest, deleteAccountRequest } from '@/api/account.js'
...
onMounted(async () => {
  try {
    ...
    if (response.code == 200) {
      ...
      now_password.value = userData.password
      organizationId.value = userData.userData;
      ElMessage({
        type: 'success',
