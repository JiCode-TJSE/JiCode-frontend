<template>
  <el-container class="container" id="allproduct">
    ...
    <el-header class="header">
      ...
      <el-button class="addproduct" type="primary" @click="showDialog"><el-icon>
          <Plus />
        </el-icon>&nbsp;&nbsp;新建产品</el-button>
    </el-header>
    <el-main class="main">
      <el-table :data="allproductsData" style="width: 100%">
    ...
    <el-dialog v-model="editDialogVisible" title="编辑产品" @close="handleEditClose">
      <el-form :model="editForm" label-width="80px">
        ...
        <el-form-item label="产品描述">
          <el-input v-model="editForm.detail" :autosize="{ minRows: 4, maxRows: 8 }" type="textarea"
            placeholder="Please input" />
        </el-form-item>
        <el-form-item>
...
const account_id = "1"//localStorage.getItem("accountId")
