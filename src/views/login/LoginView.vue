  ...
  <div id="login" class="background-image">
    <el-card class="login-card">
      ...
      <form>
        ...
        <el-cascader v-if="chooseAccountId === true" :options="options" v-model="selectedValues" @change="handleChange"
          placeholder="请选择账号" style="margin-top: 20px; margin-left: 50px;" />
      </form>
      <div class="section">
