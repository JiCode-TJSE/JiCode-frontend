...
export function deleteRequire(data) {
    return request({
        url: "http://121.40.53.98:8081/api/productdev/backlogitem",
        method: "DELETE",
        params: data
    })
}
...
export function updateRequire(data) {
    ...
    return request({
        url: "http://121.40.53.98:8081/api/productdev/requirement",
        method: "PUT",
        data: data
    })
}
...
export function switchVersion(data) {
    ...
    return request({
        url: "http://121.40.53.98:8080/api/product/version/switch",
        method: "PUT",
        params: data
    })
}
...
export function addVersion(data) {
    console.log("addVersion", data)
    return request({
        url: "http://121.40.53.98:8080/api/product/version",
        method: "POST",
        data: data
    })
}
...
export function deleteProductRequire(data) {
    return request({
        url: "http://121.40.53.98:8080/api/product/requirement",
        method: "DELETE",
        params: data
    })
}
export function getProductRequireInPage(data) {
    return request({
        url: "http://121.40.53.98:8080/api/product/requirments",
        method: "GET",
        params: data
    })
}
