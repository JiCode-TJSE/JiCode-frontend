...
export function getAllBacklogItems(data) {
    console.log(data)
    return request({
        url: `http://121.40.53.98:8081/api/productdev/backlogitems`,
        method: "GET",
        params: data,
    });
}
...
export function deleteRelatedItem(data) {
    return request({
        url: `http://121.40.53.98:8081/api/productdev/associate`,
        method: "DELETE",
        params: data,
    });
}
...
export function addRelatedItems(data) {
    return request({
        url: `http://121.40.53.98:8081/api/productdev/relation`,
        method: "POST",
        data: data,
    });
}
...
export function getManageItems(data) {
    return request({
        url: `http://121.40.53.98:8081/api/productdev/manageditems`,
        method: "GET",
        params: data,
    });
}
